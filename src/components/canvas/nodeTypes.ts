...
export const CANVAS_NODE_TYPES: CanvasNodeTypeMeta[] = [
  ...
  },
  {
    ...
    tag: "SANDBOX·VM",
    icon: Code2,
    description: "Execute safe isolated Python or JavaScript code with context variables.",
    accent: "border-yellow-500/70 text-yellow-600 dark:text-yellow-400",
    ...
    defaults: {
      codeLanguage: "python",
      codeSnippet: "return {'status': 'ok', 'processed': input}",
      codeInputs: {},
    },
  },
  {
    ...
    tag: "SWARM·VOTE",
    icon: Scale,
    description: "Poll multiple LLMs in parallel and synthesize majority vote or consensus.",
    ...
    defaults: {
      ...
      consensusModels: ["groq/compound", "google/gemma-4-26b-a4b-it:free", "cohere/north-mini-code:free"],
    },
  },
  {
    type: "critic",
    ...
    tag: "RED-TEAM·REFINE",
    icon: ShieldAlert,
    description: "Iterative adversarial review and prompt refinement loop.",
    accent: "border-rose-500/70 text-rose-600 dark:text-rose-400",
    badgeClass: "bg-rose-50 dark:bg-rose-500/15 text-rose-700 dark:text-rose-400 border-rose-200 dark:border-rose-500/40",
    defaults: {
      criticRubric: "Check for accuracy, adherence to constraints, safety, and logical consistency.",
      criticMaxTurns: 2,
      criticPassScore: 80,
    },
  },
