...
const COPILOT_SYSTEM_PROMPT = `You are a graph architect for Agent Hub. Given a natural language description of a multi-agent system, generate a complete AgentGraphDefinition JSON.
