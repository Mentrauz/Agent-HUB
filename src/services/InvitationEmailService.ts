...
export class InvitationEmailService {
  ...
  async sendInvitation(params: SendInvitationEmailParams): Promise<EmailResult> {
    ...
    const subject = `You're invited to join ${organizationName} on Agent Hub`;
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p><strong>${inviterName}</strong> has invited you to join their organization on Agent Hub.</p>
    ...
    <div class="footer">
      ...
      <p>© ${new Date().getFullYear()} Agent Hub. All rights reserved.</p>
    </div>
  </div>
</body>
</html>
    ...
    const textContent = `
You're invited to join ${organizationName} on Agent Hub

${inviterName} has invited you to join their organization on Agent Hub.
