...
export function parseAwesomeMcpServers(markdown: string): AwesomeMcpServer[] {
  ...
  for (const line of lines) {
    ...
    if (trimmed.startsWith("- [") && trimmed.includes("](")) {
      ...
      // Only match genuine endpoint URLs (excluding GitHub, Glama, and mcpservers.org directory links)
      const rawHttpMatch = trimmed.match(
      ...
      else if (trimmed.includes("🐍") || (command && command.includes("uvx"))) language = "python";
