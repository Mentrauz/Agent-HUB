...
/**
 * Maps an n8n node type string to Agent Hub GraphNodeType.
 */
...
/**
 * Converts an n8n workflow JSON into an Agent Hub AgentGraphDefinition.
 */
export function convertN8nToAgentGraph(n8nWorkflow: N8nWorkflowData): AgentGraphDefinition {
  ...
  // Calculate bounding box to normalize coordinates into Agent Hub viewport
  let minX = Infinity;
  let minY = Infinity;
  let maxX = -Infinity;
  let maxY = -Infinity;
...
/**
 * Converts an n8n workflow into an Agent Hub WorkflowTemplate.
 */
