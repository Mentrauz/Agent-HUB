...
/**
 * Maps a Dify node type string to an Agent Hub GraphNodeType.
 */
...
/**
 * Converts a Dify Workflow DSL (nodes + edges) into an Agent Hub AgentGraphDefinition.
 */
...
/**
 * Converts Dify template metadata into an Agent Hub WorkflowTemplate.
 */
