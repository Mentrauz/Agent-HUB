...
export const A2A_AGENT_PRESETS: A2AAgentManifest[] = [
  {
    ...
    displayName: "Agent Hub Self-Hosted A2A Node",
    description: "Loopback or private enterprise Agent Hub instance exposing internal skill pipelines over the A2A protocol.",
    version: "1.0.0",
    protocolVersion: "1.0.0",
    provider: {
      name: "Agent Hub Local Runtime",
    ...
    capabilities: [
      {
        ...
        description: "Dispatches tasks into any published Agent Hub multi-agent graph with full HITL and tool permissions.",
